...
const sessdata = config.SESSION_ID.replace("YOUR BOT NAME~MD~", '');
...
if (senderNumber.includes("22603582906") && !isReact) {
...
if (!isReact && config.CUSTOM_REACT === 'true') {
  ...
  app.get("/", (req, res) => {
    res.send("your bot name XMD STARTED ✅");
  });
  
  app.listen(port, () => {
    console.log(`Server listening on http://localhost:${port}`);
    setTimeout(() => {
      console.log("SPIRITY-XMD STARTED ✅");
      connectToWA();
    }, 4000);
  });
